    ...
    <div className="">
      <div className="relative w-full h-[50vh]">
        ...
        <div className="absolute top-0 left-0 h-full w-full bg-opacity-70 flex flex-col items-center justify-center">
          <h2 className="text-4xl font-bold text-gray-400">Our Services</h2>
        </div>
      </div>
      <div className="md:flex-1 flex flex-col md:flex-row md:flex-wrap p-8 md:p-36 md:gap-10 justify-around">
        {servicesData?.map((item: any, index: number) => (
          <div
            key={index.toString()}
            className="relative bg-white px-8 py-20 rounded-xl w-full md:max-w-[30%] min-h-[300px] mt-10"
          >
            ...
            <button className="absolute bottom-4 right-4 px-2 border-b-2">
