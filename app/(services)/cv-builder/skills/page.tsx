...
const Skills = () => {
  ...
  const [selectedSkillForDel, setSelectedSkillForDel] = useState<string>("");
    ...
    <div className="p-4 md:px-20 flex md:flex-row justify-center">
      <section className="w-full md:w-[60%]">
        <p className="text-2xl font-bold font-sans text-gray-600">
          Add your <span className="text-blue-600">skills</span>
        </p>
        <div className="w-full p-4 space-y-4">
              ...
              {skills?.map((skill: any, index: number) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    {isDeleting && selectedSkillForDel === skill ? (
          ...
          <div
            ...
            onClick={() => setAddSkillToggle(true)}
          >
            <FaPlus />
            <p>Add Skill</p>
          </div>
      ...
      {addSkillToggle && (
        <AddSkillModal
          handleClose={() => setAddSkillToggle(false)}
